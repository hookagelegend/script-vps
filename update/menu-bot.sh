...
Isadmin=$(curl -sS https://raw.githubusercontent.com/hookagelegend/ijin/refs/heads/main/original | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/hookagelegend/ijin/refs/heads/main/original | grep $MYIP | awk '{print $3}')
fi
