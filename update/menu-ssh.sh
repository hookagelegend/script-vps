...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/hookagelegend/script-vps/refs/heads/main/ssh/proxy3.js.bak"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://github.com/hookagelegend/script-vps/edit/main/update/menu-ssh.sh" && chmod +x /usr/bin/ssh-wsenabler
